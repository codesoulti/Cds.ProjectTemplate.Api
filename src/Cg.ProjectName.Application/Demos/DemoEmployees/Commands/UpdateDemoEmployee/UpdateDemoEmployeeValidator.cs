...
public class UpdateDemoEmployeeValidator : AbstractValidator<UpdateDemoEmployeeCommand>
{
    public UpdateDemoEmployeeValidator()
    {
        RuleFor(x => x.Id)
            .NotEmpty()
        ...
        RuleFor(x => x.Document)
            ...
            // INSERT/UPDATE, virando um 500 genérico via ValidationExceptionMiddleware
